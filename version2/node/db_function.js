...
exports.user = function (request, response) {
    db.query(`call check_user(?,?, ?);`, ["diana", "여", 24/*post에서 받은 name sex age*/], function (error, result) {
        if (error) {
...
exports.cms = function (request, response) {
    db.query(`call UpdateCMS(?, ?);`, ["top", "diana"/*post에서 받은 contentname, userid */], function (error, result) {
        if (error) {
